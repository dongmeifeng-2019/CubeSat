...
plot(c(1:nrow(ts1)),ts1$Gauge_Q,font=2,type='l',col='black',xlim=c(1,10),tck=-0.03,lwd=2,cex.lab=size,cex.axis=size,
...
plot(c(1:nrow(ts2)),ts2$Gauge_Q,font=2,type='l',col='black',tck=-0.03,lwd=2,cex.lab=size,cex.axis=size,
     ylab=expression(paste('Discharge (m'^3,'/s)',sep='')),
     ylim=c(min(output_all$Gauge_Q,na.rm=T),max(output_all$Gauge_Q,na.rm=T)*1.1))
lines(c(1:nrow(ts2)),ts2$ST,col='red')
lines(c(1:nrow(ts2_1)),ts2_1$ST,col='blue')
legend('topright',c('Gauge','BAM','Rating Curve'),col=c('black','red','blue'),lty=1,bty='n',lwd=c(2,1,1))
...
par(mar=c(1,3.0,1.1,1.1),mgp=c(1.5,0.5,0),family = "serif")
plot(c(1:nrow(ts3)),ts3$Gauge_Q,font=2,type='l',col='black',tck=-0.03,lwd=2,cex.lab=size,cex.axis=size,
     ylab=expression(paste('Discharge (m'^3,'/s)',sep='')),
     ylim=c(min(output_all$Gauge_Q,na.rm=T),max(output_all$Gauge_Q,na.rm=T)*1.1))
...
par(mar=c(1,3.0,1.1,0),mgp=c(1.5,0.5,0),family = "serif")
plot(c(1:nrow(ts4)),ts4$Gauge_Q,font=2,type='l',col='black',tck=-0.03,lwd=2,cex.lab=size,cex.axis=size,
     ylab=expression(paste('Discharge (m'^3,'/s)',sep='')),
     ylim=c(min(output_all$Gauge_Q,na.rm=T),max(output_all$Gauge_Q,na.rm=T)*1.1))
...
par(mar=c(1,3.0,1.1,1.1),mgp=c(1.5,0.5,0),family = "serif")
plot(c(1:nrow(ts5)),ts5$Gauge_Q,font=2,type='l',col='black',tck=-0.03,lwd=2,cex.lab=size,cex.axis=size,
     ylab=expression(paste('Discharge (m'^3,'/s)',sep='')),
     ylim=c(min(output_all$Gauge_Q,na.rm=T),max(output_all$Gauge_Q,na.rm=T)*1.1))
...
plot(c(1:nrow(ts6)),ts6$Gauge_Q,font=2,type='l',col='black',tck=-0.03,xlab='Time Step',lwd=2,cex.lab=size,cex.axis=size,
     ylab=expression(paste('Discharge (m'^3,'/s)',sep='')),
     ylim=c(min(output_all$Gauge_Q,na.rm=T),max(output_all$Gauge_Q,na.rm=T)*1.1))
